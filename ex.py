...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_3.setItemText(2, _translate("Form", "提現完成回調"))
        self.comboBox_3.setItemText(3, _translate("Form", "玩家充值(获取在线支付地址)"))
        self.comboBox_3.setItemText(4, _translate("Form", "支付完成回调"))
        self.comboBox_3.setItemText(5, _translate("Form", "订单查询"))
        self.comboBox_3.setItemText(6, _translate("Form", "提现订单查询"))
        self.comboBox_3.setItemText(7, _translate("Form", "商户访客获取令牌"))
        self.comboBox_3.setItemText(8, _translate("Form", "商户端访客充值"))
        self.comboBox_3.setItemText(9, _translate("Form", "商户端访客验证后充值"))
        self.comboBox_3.setItemText(10, _translate("Form", "商户端访客余额查询"))
...
if __name__ == "__main__":
    ...
    action_list=[
        ...
        {'action_name':'提現完成回調','item_number':6,'value':['merchantNo','merchantOrderNo','amount','orderNo','payStatus','remark'],'web_action':'post','api':''},
        ...
        {'action_name':'支付完成回调','item_number':4,'value':['merchantNo','merchantOrderNo','amount','orderNo'],'web_action':'post','api':''},
    ...
    def onComboBoxChanged():
        ...
        # 商户端访客验证后充值
        elif action == action_list[9]['action_name']:
            remove_data()
            ui.lineEdit.setText('')
            ui.lineEdit_2.setText('')
            timestamp = int(time.time())
            ...
            print(f'merchantOrderNo:{timestamp}')
            # 取得GET還是POST
            api_method = action_list[9]['web_action']
            print(f'api_method={api_method}')
            ui.tableWidget.setRowCount(0)
            for i in range(action_list[9]['item_number']):
                # rowPosition = ui.tableWidget.rowCount()
                ui.tableWidget.insertRow(i)
                ui.tableWidget.setItem(i, 0, QtWidgets.QTableWidgetItem(action_list[9]['value'][i]))
            ui.tableWidget.setItem(0, 1, QtWidgets.QTableWidgetItem(f'{merchantNo}'))
            ui.tableWidget.setItem(2, 1, QtWidgets.QTableWidgetItem(f'{timestamp}'))
            ui.tableWidget.setItem(4, 1, QtWidgets.QTableWidgetItem(f'{amount}'))

        # 商户端访客余额查询
        elif action == action_list[10]['action_name']:
            remove_data()
            ui.lineEdit.setText('')
            ui.lineEdit_2.setText('')
            timestamp = int(time.time())
            ...
            print(f'merchantOrderNo:{timestamp}')
            # 取得GET還是POST
            api_method = action_list[10]['web_action']
            print(f'api_method={api_method}')
            ui.tableWidget.setRowCount(0)
            for i in range(action_list[10]['item_number']):
                # rowPosition = ui.tableWidget.rowCount()
                ui.tableWidget.insertRow(i)
                ui.tableWidget.setItem(i, 0, QtWidgets.QTableWidgetItem(action_list[10]['value'][i]))
        else:
            return
    ...
    def send_api():
        ...
        if action == action_list[0]['action_name']:
            ...
            api_url = action_list[9]["api"]
            print(f'action={action}')
        else:
            api_url = action_list[10]["api"]
        # print(api_url)
