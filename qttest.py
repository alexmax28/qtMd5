...
if __name__ == "__main__":
    ...
    def onComboBoxChanged():
        ...
        global mainkey
        global api_method
        merchantNo = {"test":"MSN2023042416823040844899JzZXEte","uat":"MSN202210211666321670131hfEL9mHx"}
        mainkeyList = {"test":"2af9502317144a86887c9975dc4eae01","uat":"15a873ee9261406fbbba27b3aa197de3"}
        userMobile = {"test":"18177777777","uat":"13123456789"}
        ...
        if action == action_list[0]['action_name']:
            ...
            if envstr == 'TEST':
                ui.tableWidget.setItem(0, 1, QtWidgets.QTableWidgetItem(f'{merchantNo["test"]}'))
                ...
                ui.tableWidget.setItem(3, 1, QtWidgets.QTableWidgetItem(f'{userMobile["test"]}'))
                ui.lineEdit.setText(f'{mainkeyList["test"]}')
            elif envstr == 'UAT':
                ui.tableWidget.setItem(0, 1, QtWidgets.QTableWidgetItem(f'{merchantNo["uat"]}'))
                ui.tableWidget.setItem(1, 1, QtWidgets.QTableWidgetItem(f'{timestamp}'))
                ui.tableWidget.setItem(2, 1, QtWidgets.QTableWidgetItem(f'{amount}'))
                ui.tableWidget.setItem(3, 1, QtWidgets.QTableWidgetItem(f'{userMobile["uat"]}'))
                ui.lineEdit.setText(f'{mainkeyList["uat"]}')
        ...
        # 订单查询
            ...
            if envstr == 'TEST':
                ui.tableWidget.setItem(1, 1, QtWidgets.QTableWidgetItem(f'{merchantNo["test"]}'))
                ui.lineEdit.setText(f'{mainkeyList["test"]}')
            elif envstr == 'UAT':
                ui.tableWidget.setItem(1, 1, QtWidgets.QTableWidgetItem(f'{merchantNo["uat"]}'))
                ui.lineEdit.setText(f'{mainkeyList["uat"]}')
    ...
    def onComboBox2Changed():
        ...
        if envstr == "TEST":
            ...
            print(envurl)
            ui.lineEdit.setText('2af9502317144a86887c9975dc4eae01')
            ui.tableWidget.clearContents()
        elif envstr == "UAT":
            envurl = env_list[1]['uat']
            print(envurl)
            ui.lineEdit.setText('15a873ee9261406fbbba27b3aa197de3')
            ui.tableWidget.clearContents()
        else:
            print('err')
    ...
    ui.tableWidget.setItem(1, 1, QtWidgets.QTableWidgetItem(f'{timestamp}'))
    ui.tableWidget.setItem(2, 1, QtWidgets.QTableWidgetItem(f'{amount}'))
    ui.tableWidget.setItem(3, 1, QtWidgets.QTableWidgetItem('18177777777'))
